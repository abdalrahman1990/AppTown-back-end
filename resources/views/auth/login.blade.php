...
@section('content')
    ...
    <div class="full" style="background-image:url('#' );
...
{{--                    </p>--}}
                   <center>
                        <button class="loginBtn loginBtn--facebook">
                            <a href="{{ route('fblogin') }}" style="color: white">Login with Facebook</a>
                        </button>

                        <button class="loginBtn loginBtn--google">
                            <a href="{{ route('gologin') }}" style="color: white">Login with Google</a>
                        </button>
                   </center>
